...
<div className='flex flex-col '><div className='lg:text-[1.5vw] md:text-[2vw] text-[4vw]'>Average Rating</div><Starcomponent star={avgrating}/>{avgrating &&<div className='text-[3vw]  md-text-[2.2vw] lg:text-[2vw]'>({avgrating})</div>}</div>
<div className='flex mx-auto w-[55%]  h-fit flex-col'> {feedbackdetail.length?feedbackdetail.map((ele,index)=> 
     ...
     </div>):<div className='lg:text-[1.5vw] md:text-[2vw] text-[3vw]'>No Reviews Yet</div>}</div>
    </div>
